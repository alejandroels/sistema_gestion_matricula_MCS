                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('matriculas.destroy',$matricula->id) }}" method="POST" class="d-inline-block">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" onclick="return confirm('¿Está seguro que desea eliminar estos datos?')" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i> {{ __('Eliminar') }}</button>
                                                </form>
